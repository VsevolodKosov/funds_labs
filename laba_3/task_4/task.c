...
int main(int argc, char **argv)
{
    ...
    while ((user_ans = getchar()) != '0')
    {
        ...
        case '1':
        {
            if ((state = add_mail(&post, &count_mails)) == MemoryError)
            {
        ...
        case '2':
        {
            if ((state = delete_mail(&post, &count_mails)) == MemoryError)
            {
                printf("Add_mail: memory error");
            }
            else if (state == InputError)
        ...
        case '3':
        {
            if ((state = search_mail(&post, &count_mails)) == MemoryError)
            {
        ...
        case 'd':
        {
            if ((state = set_delivered(&post, &count_mails)) == MemoryError)
            {
